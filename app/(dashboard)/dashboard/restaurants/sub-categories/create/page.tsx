...
export default function CreateSubCategoryPage() {
  ...
  const addSubCategory = useRestaurantStore((state) => state.addSubCategory)
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    addSubCategory(newSubCategory as any)
  ...
  return (
    <div className="p-6">
      ...
      <div className="max-w-2xl mx-auto">
        <Card className="p-6">
          <h1 className="text-3xl font-bold mb-6">Create Sub Category</h1>
