...
export default function EditMenuItemPage() {
  ...
  useEffect(() => {
    const menuItem = restaurantData.menuItems.find((m) => m.id === params.id)
    if (menuItem) {
      setFormData({
        categoryIds: menuItem.categoryIds || [], // Fallback for legacy items
        name: menuItem.name || "",
        sku: (menuItem as any).sku || "",
        description: menuItem.description || "",
        price: menuItem.price.toString(),
        discountPrice: (menuItem.discountPrice || "").toString(),
        dietaryType: menuItem.dietaryType || "VEG", // Default if missing
    ...
    setLoading(false)
  }, [params.id, restaurantData.menuItems])
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    updateMenuItem(params.id as string, {
      categoryIds: formData.categoryIds,
      name: formData.name,
      // sku: formData.sku, // If store supports it
